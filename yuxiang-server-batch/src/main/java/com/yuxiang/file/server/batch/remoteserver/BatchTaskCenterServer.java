package com.yuxiang.file.server.batch.remoteserver;

import com.yuxiang.file.remote.iface.batch.IBatchTaskCenterBatch;
import com.yuxiang.file.server.batch.service.BatchTaskCenterService;
